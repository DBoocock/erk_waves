...
if __name__ == "__main__":
    ...
    executable = Path("/home/chaste/lib/projects/erk_waves/test/TestERKWaveWithSelfPropulsionWithAlignment")
    ...
    outdir_stem = "erk_waves_with_alignment_output/"
    ...
    outdir_labels = ["nx", "dt", "P0", "n_abcrit", "ab_ratio", "F0", "tau_p", "tau_a", "seed"]
